...
def config():
    ...
    with open(config_fileName, "r") as file:
        ...
        # log file number 
        processNumber = int(lines[2].strip()) if len(lines) >= 3 else 0
    ...
    return(serverIP, int(serverPort)), (clientIP, int(clientPort)), processNumber
